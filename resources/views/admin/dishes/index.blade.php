                            ...
                            <div class="modal fade" id="deleteModal{{ $dish->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $dish->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">Are you sure you want to delete this dish? This operation is not reversible.</div>
                                        <div class="modal-footer">
                                            <!-- Delete -->
                                            <form action="{{ route('admin.dishes.delete', $dish) }}" method="POST" style="display: inline;">
                                                @method('DELETE')
                                                @csrf
