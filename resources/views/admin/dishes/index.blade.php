                    ...
                    @foreach ($restaurants as $restaurant)
                        @forelse ($restaurant->dishes as $dish)
                            <tr class="align-middle">
                                <td>
                                    <img class="img-dish" src="{{ asset('/storage/' . $dish->img) }}"
                                        alt="{{ $dish->name }}">
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel{{ $dish->id }}">
                                                {{ $dish->name }}</h5>
                                        </div>
                                        <div class="modal-body">Are you sure you want to delete this dish? This operation is
                                            not
                                            reversible.</div>
