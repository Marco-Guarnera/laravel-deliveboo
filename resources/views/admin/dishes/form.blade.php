                        ...
                        <form id="dishes-form" action="@yield('form-action')" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="dish-name"
                                    ...
                                    value="{{ old('name', $dish->name) }}" placeholder="e.g., Margherita Pizza"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="dish-description" class="form-control @error('description') is-invalid @enderror" name="description"
                                    placeholder="e.g., A delicious classic pizza..." maxlength="500">{{ old('description', $dish->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
